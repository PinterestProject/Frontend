...
export default class FormSignup extends Component {
            ...
            handleEditProfile=()=>{
              ...
              axios.patch(`http://localhost:8000/users/users/${id}/`,
              send_data, { headers: { "Authorization": localStorage.getItem("Token") } }).then((resp)=>{
                this.setState({
                      ...
                      <div className="p-3 py-2">
                        ...
                        <div className="row mt-3">
                          ...
                          <div className="col-md-12">
                            ...
                            <input onChange={this.handleChange} value={birth_day}  
                                    name="birth_day" 
                                    className="Inputs" 
                                    type="date" 
